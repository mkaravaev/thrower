defmodule Thrower.AttackMode.PrioritizeVaderTest do
  use ExUnit.Case
  ...
  test "should return only entry w/o good characters" do
    entries = [
      %RadarEntry{
        ...
        villains: [
          ...
          %RadarEntry.Villain{costume: "Darth Vader", malice: 20}
        ]
      },
      %RadarEntry{
    ...
    } = AttackMode.PrioritizeVader.apply(entries)
  end

  test "should prioritize Darth Vader" do
    entries = [
      %RadarEntry{
        position: %RadarEntry.Position{x: 0, y: 20},
        villains: [%RadarEntry.Villain{costume: "Voldemort", malice: 20}]
    ...
    assert %{position: %{x: 0, y: 30}} = AttackMode.PrioritizeVader.apply(entries)
  end
end
